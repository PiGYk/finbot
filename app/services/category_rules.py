...
DEFAULT_CATEGORY_CATALOG: List[Dict[str, Any]] = [
    {
        ...
        "description": "Базові продукти для дому: м'ясо, бакалія, молочка, яйця, хліб (без овочів та фруктів).",
        "aliases": [
        ...
        "examples": ["курка", "гречка", "яйця", "хліб", "молоко"],
    },
    {
        "canonical_name": "Овочі та фрукти",
        "description": "Свіжі овочі та фрукти, зелень, ягоди.",
        "aliases": [
            "овочі", "фрукти", "овочі та фрукти", "свіжі овочі", "свіжі фрукти",
            "яблука", "банани", "груші", "апельсини", "мандарини", "лимони", "грейпфрут", "ківі",
            "помідори", "огірки", "картопля", "цибуля", "морква", "капуста", "буряк", "перець",
            "кабачки", "баклажани", "редиска", "салат", "зелень", "кріп", "петрушка", "часник",
            "ягоди", "полуниця", "виноград", "черешня", "вишня", "малина", "чорниця"
        ],
        "examples": ["помідори", "огірки", "яблука", "банани", "морква"],
    },
    {
        "canonical_name": "Вода",
    ...
    },
    {
        ...
        "aliases": [
            ...
            "сирок", "круасан", "лаваш", "рол з куркою", "готовий обід", "кулінарія", "чебурек", "чебуреки",
