...
class ListParser:
    ...
    def _guess_category_from_list(self, name: str) -> str:
        ...
        # ПРОДУКТИ (молочка, м'ясо, хліб)
            ...
            "творог", "м'ясо", "яловичина", "курка", "курячина", "свинина", "стейк",
            "фарш", "ковбаса", "ковбаски", "сосиск", "бекон", "ветчин", "копчено",
            "риба", "форель", "окунь", "карась", "сома", "креветки", "краб", "устриці",
            "хліб", "батон", "булка", "ломтик", "сухарь", "брашно", "мука", "борошно",
            "дріжджі", "гріш", "печиво", "печенье", "пайчик"
        ]):
            return "Продукти"
