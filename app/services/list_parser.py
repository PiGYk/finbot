...
class ListParser:
    ...
    def _guess_category_from_list(self, name: str) -> str:
        ...
        if any(kw in name_lower for kw in [
            "пиво", "вино", "водка", "коньяк", "бренди", "виски", "ром", "джин", 
            "ліквер", "шампанськ", "просекко", "гіне", "абсент", "текіла", "мезкал",
            "fragolino", "martini", "jim beam", "bacardi", "guinness", "heineken"
        ]):
            return "Алкоголь"
        
        # ОВОЧІ ТА ФРУКТИ - розширена
        elif any(kw in name_lower for kw in [
            "овоч", "фрукт", "ябл", "апель", "морк", "цибул", "помідор", "огірок",
            "батат", "авокад", "банан", "груша", "слива", "вишня", "малина", "суниця",
            "лимон", "апельсин", "мандарин", "грейпфрут", "киви", "ананас", "манго",
            "папая", "персик", "абрикос", "картофель", "картопля", "капуста", "броколі",
            "цвітна капуста", "баклажан", "перець", "салат", "шпинат", "укроп", "петрушка",
            "сніг", "спаржа", "редис", "буряк", "ріпа", "кабачок", "цукіні"
        ]):
            return "Овочі та фрукти"
        
        # ПРОДУКТИ (молочка, м'ясо, хліб)
        elif any(kw in name_lower for kw in [
            "молок", "смет", "сметан", "сір", "масло", "яйц", "йогурт", "кефір",
            "творог", "молоко", "сметана", "сыр", "масло",
            "м'ясо", "м'яса", "мясо", "яловичина", "курка", "курячина", "свинина", "стейк",
            "грудинка", "грудина", "філе", "філей", "крило", "ніжка", "рулет",
            "фарш", "ковбаса", "ковбаски", "сосиск", "сосиски", "бекон", "ветчин", "копчено",
            "ребро", "реберця", "косточка", "котлета", "тефтель", "гуляш", "паштет",
            "салямі", "прошут", "спек", "грудь", "окорок", "ляжка",
            "риба", "риби", "рыба", "форель", "окунь", "карась", "сома", "креветки", "краб", "устриці",
            "селедка", "скумбрія", "лосось", "тріска", "мінтай", "судак", "щука", "лящ",
            "хліб", "батон", "булка", "ломтик", "сухарь", "брашно", "мука", "борошно",
            "дріжджі", "гріш", "печиво", "печенье", "пайчик", "булочка", "булочки",
            "макаронні", "макарони", "макароны", "спагетті", "паста", "рис", "рисова",
            "гречка", "гречневий", "полтавець", "перловка", "ячмінь"
        ]):
            return "Продукти"
        ...
        # СОЛОДКІ НАПОЇ - розширена (але не алкоголь!)
        elif any(kw in name_lower for kw in [
            "кола", "спрайт", "пепси", "фанта", "севен ап", "7up", "лимонад",
            "сік", "апельсиновий", "яблучний", "томатний", "морс", "компот",
            "напій", "газований", "розчин", "каво", "какао", "гарячий шоколад",
            "cordial", "squash", "растворимый"
        ]):
